...
> 本文首发于简书：[《关于开源的一些注意事项》](http://www.jianshu.com/p/72fe46d4b5ae)，欢迎关注[我的简书](http://www.jianshu.com/users/ca00dd5e52a4/latest_articles)。

# 开源协议概要
目前开源的协议可以参考GNU组织的开源许可协议：[具体参考链]。(http://www.gnu.org/licenses/license-list.html)
现今存在的开源协议很多，而经过Open Source Initiative组织通过批准的开源协议目前有58种：[具体参考链](https://opensource.org/licenses/alphabetical)。
下面来看几个例子：
[Facebook的Github](https://github.com/facebook)中的开源项目大部分都是使用BSD开源协议，BSD协议允许使用者修改和重新发布代码（以其他协议形式），允许闭源商业发布和销售，如果在再发布的产品中包含源码，则必须带有原来代码中的BSD协议，不可以使用Facebook的名字来做市场推广等。
<!--more-->
Google的Android则是使用[Apache v2 License](http://opensource.org/licenses/Apache-2.0)协议 ，这个协议和BSD类似，允许修改代码再发布，可以用作商业软件而不用公布修改之后的源码，但是这个协议鼓励代码共享尊重作者的著作权。
Linux 使用了GPL 协议，而GPL代码规定所有使用了GPL代码的代码，必须开源。如果一些商用软件采用了GPL开源协议的源码，则必须公布自己的源码。
...
* [git oschina相关介绍](http://git.oschina.net/oschina/git-osc/wikis/License)
